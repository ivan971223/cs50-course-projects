...
db.execute("CREATE TABLE orders (id INTEGER, user_id INTEGER NOT NULL, orderDate NUMERIC NOT NULL, food_id INTEGER NOT NULL, name TEXT NOT NULL, number INTEGER NOT NULL, total REAL NOT NULL, FOREIGN KEY(user_id) REFERENCES users(id), FOREIGN KEY(food_id) REFERENCES food(id))")
