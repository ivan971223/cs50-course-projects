...
db.execute("CREATE TABLE order (id INTEGER, user_id INTEGER NOT NULL, timestamp REAL NOT NULL, food_id INTEGER NOT NULL, number INTEGER NOT NULL, FOREIGN KEY(user_id) REFERENCES users(id), FOREIGN KEY(food_id) REFERENCES food(id))")
